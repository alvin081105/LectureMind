...
export default function ProfessorDashboard() {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100">교수 대시보드</h2>
                ...
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0">
                    <Link
                      ...
                      className="text-sm font-medium text-gray-800 dark:text-gray-100 hover:text-indigo-600 dark:hover:text-indigo-400 truncate block transition-colors"
                    >
                      {lecture.title}
                    </Link>
                ...
                {lecture.status === 'COMPLETED' && (
                  <div className="mt-3 flex gap-2">
                    <Link
                      ...
                      className="flex-1 text-center py-1.5 text-xs font-medium text-indigo-600 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-700 rounded-lg hover:bg-indigo-50 dark:hover:bg-indigo-900/20"
                    >
                      분석 보기
                    </Link>
                    <button
                      ...
                      className="flex-1 py-1.5 text-xs font-medium text-purple-600 dark:text-purple-400 border border-purple-200 dark:border-purple-700 rounded-lg hover:bg-purple-50 dark:hover:bg-purple-900/20 disabled:opacity-50"
                    >
